...
namespace Drupal\Tests\juicebox\Functional {
  ...
  abstract class JuiceboxCaseTestBase extends BrowserTestBase {
     ...
     * @var string
     */
    protected string $instBundle = 'juicebox_gallery';
     ...
     * @var string
     */
    protected string $instFieldName = 'field_juicebox_image';
     ...
     */
    protected function createNodeWithFile($file_type = 'image', $multivalue = TRUE, $add_title_caption = TRUE): bool {
     ...
     *   The response body.
     */
    protected function renderContextualLinks(array $ids, string $current_path): string {
      $post = [];
