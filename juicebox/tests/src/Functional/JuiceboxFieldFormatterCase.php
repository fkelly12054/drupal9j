...
class JuiceboxFieldFormatterCase extends JuiceboxCaseTestBase {
  ...
  public function testFieldFormatterConf() {
    ...
    $this->assertSession('Test Juicebox Gallery Node. Juicebox node found in search for title text.');
  ...
  public function testFieldFormatterAccess() {
    ...
    // restricted, such as other perm settings, contrib module controls for
    // entities (node_access, tac, etc.), contrib module controls for fields
