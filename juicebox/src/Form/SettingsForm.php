...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (array_key_exists('base_languagelist', $library) && empty($settings['base_languagelist'])) {
    ...
    $form['multilingual']['base_languagelist_suggestion'] = [
      ...
      '#description' => new FormattableMarkup('<pre>' . $settings['base_languagelist'] . '</pre>', []),
      '#states' => [
        // Hide the settings when the translate option is disabled.
        'invisible' => [
          ':input[name="translate_interface"]' => ['checked' => FALSE],
    ...
    $multisize_disallowed = (array_key_exists('disallowed_conf', $library) && in_array('juicebox_multisize_image_style', $library['disallowed_conf']));
